...
@section('title', $projectSingle->title))
                        ...
                        <div class="post format-gallery">
                            <div class="entry-media">
                                <div class="post-slider owl-carousel">
                                    @foreach($projectSingle->photo AS $projePhoto)
                                        <img src="{{ asset("storage/" . $projePhoto) }}" alt>
                                    @endforeach
                                </div>
                            ...
                            <div class="entry-meta">
                                <ul>
                                    <li><i class="fi flaticon-calendar"></i> {{ $projectSingle->published_at }}</li>
                                </ul>
                            </div>
                            <div class="entry-details">
                                <p>{!! \App\Helpers\MarkdownHelper::toHtml($projectSingle->content) !!}</p>
                            </div>
                        </div>
                    </div>
                </div>
